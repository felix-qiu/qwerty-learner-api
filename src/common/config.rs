...
pub struct Config {
    ...
    pub xinference_base_url: String,
    pub xinference_image_model: String,
    pub xinference_image_size: String,
    pub xinference_image_steps: u32,
    pub xinference_image_guidance_scale: f32,
    pub xinference_request_timeout_secs: u64,
}
