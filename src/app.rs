...
fn create_swagger_ui() -> SwaggerUi {
    SwaggerUi::new("/docs").urls(vec![
        (
            Url::with_primary("Images", "/api-docs/image/openapi.json", true),
            ImageApiDoc::openapi(),
        ),
        (
            Url::new("User Auth", "/api-docs/user_auth/openapi.json"),
            UserAuthApiDoc::openapi(),
        ),
        (
            Url::new("Users", "/api-docs/user/openapi.json"),
            UserApiDoc::openapi(),
        ),
        (
